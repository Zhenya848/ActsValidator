...
namespace UserService.Infrastructure.Migrations
{
    ...
    [Migration("20260802185921_with_permissions")]
    partial class with_permissions
    {
        /// <inheritdoc />
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("UserAccess", "UserService.Domain.User.User.UserAccess#UserAccess", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("SubscriptionExpireAt")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("user_access_subscription_expire_at");

                            b1.Property<int>("TokenBalance")
                                .HasColumnType("integer")
                                .HasColumnName("user_access_token_balance");
                        });
