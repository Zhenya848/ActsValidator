        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    priority_number = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_support_emails", x => x.id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_support_emails_email",
                table: "support_emails",
                column: "email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_support_emails_priority_number",
                table: "support_emails",
